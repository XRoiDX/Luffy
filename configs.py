...
SESSION_NAME = str(environ.get('SESSION_NAME', 'LufffuiBot'))
MULTI_CLIENT = False
name = str(environ.get('name', 'Luffy'))
...
STREAM_LOGS = environ.get('STREAM_LOGS','-1002250453956')
SESSION = environ.get('SESSION','LufffuiBot')
...
class Config(object):
	...
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002250453956")
	BANNED_USERS = set(int(x) for x in os.environ.get("BANNED_USERS", "").split())
	FORWARD_AS_COPY = bool(os.environ.get("FORWARD_AS_COPY", True))
	BROADCAST_AS_COPY = bool(os.environ.get("BROADCAST_AS_COPY", False))
	LAZY_CHANNEL = int(os.environ.get('LAZY_CHANNEL','-1002438002033'))
